...
# _MASTER BRIEFING — Protein Group
> **READ THIS FIRST every session.** This is the living master reference for the protein-group seafood project. Update it whenever key facts, people, or decisions change.

---

## The Mission

Build a vertically integrated seafood supply chain in Central America (Nicaragua primary, Honduras secondary, Costa Rica tertiary) that:
- Catches bait fish (herring, mackerel) and premium species at low cost
- Processes locally, exports directly to Canada and USA bait markets
- Produces fishmeal and fish oil for regional aquaculture feed supply — **goal: dominate Central American fishmeal market**
- Undercuts Peruvian/Chilean imported fishmeal (currently ~$1,992/tonne March 2026 — near historic high)
- Redistributes wealth into the local community — generational model, NOT a smash-and-grab
...
## Company Pyramid Structure (Sacred Geometry / Fractal Model)
...
### Row 1 — Apex
- **Christopher Bartlett** — Visionary / CSO
  - Role: strategy, relationships, ideas. Does NOT want to manage money or day-to-day ops.

### Row 2 — The Trinity (60° each — equilateral triangle)
...
| USOpCo | Delaware (TBD) | US market interface if needed | TBD |
...
- **Transfer pricing risk**: CRA is aggressive on related-company transactions. Need a qualified tax lawyer.

### 🌱 SEEDED — Unresolved Strategic Question
> **"The Sacrificial Goat"** — Which entity operates at breakeven to subsidize fishmeal pricing across Central America while the rest of the pyramid profits? CanadaCo is the current leading candidate. Must be resolved before business plan v4.
...
| **Bernadette** (Christopher's aunt) | CFO candidate A | Former Scotia McLeod rep NB/NS. Manages billionaire's portfolio. Capital markets background. |
| **Dana** (**male**) | CFO candidate B / Logistics partner | Former Irving Oil accountant. Owns Atlas Logistics Worldwide. Does NOT know about Central America project yet. |

### Industry Network — Fishing / Vessels
| Name | Role | Notes |
|---|---|---|
| **Kevin Smith** | Captain, F/V Leroy and Barry (Connors Brothers) | Main herring seining contact. Caribbean side. PRIMARY vessel relationship. |
...
| **Dwayne Beliveau** | Owner, Charlseville Fisheries (East Pubnico, NS) | ~5 fish draggers. Prior relationship via lobster buying company. |
...
|---|---|---|---|
| **Steve Penny** | Skretting (Nutreco) | Senior exec | Childhood friend. HIGH VALUE. Honduras facility needs local fishmeal. |

### People NOT to partner with
| Name | Why |
|---|---|
...
## Market Pricing (May 2026)

| Product | Price |
|---|---|
| Peruvian fishmeal (global benchmark) | ~$1,992/tonne |
| Christopher's fishmeal target (with solar) | $600–900/tonne |
...
- [ ] Call Kevin Smith — Caribbean side seiner production numbers
- [ ] Call Dwayne Beliveau — vessel sourcing conversation
